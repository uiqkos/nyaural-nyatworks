...
#     name='Full',
#     stages=[
#         PreprocessorStage(name='cleaner'),
#         PreprocessorStage(name='lemmatizer'),
#         PreprocessorStage(name='stemmer'),
#         PreprocessorStage(name='tokenizer'),
#     ]
# )
#
# model1 = Model(
...
#     title='Large CNN',
#     tags=[
#         Tag(name='CNN', color='warning'),
#         Tag(name='model', color='info'),
#         Tag(name='best', color='success')
#     ],
#     chapters=[
#         ReportChapter(
#             header='Описание',
...
#             content=[
#                 ReportChapterItem(
#                     text='В обычном перцептроне, который представляет собой полносвязную нейронную сеть, '
